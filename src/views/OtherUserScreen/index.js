  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const responseUser = await axios.get(`${SERVER_ADDRESS}/uzytkownik/${userID}`);
        const userData = await responseUser.data;
        setUser(userData);

        const response = await axios.get(`${SERVER_ADDRESS}/opinie?uzytkownikID=${userID}`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.TextContainer}>
        ...
        <Text style={styles.headerText}>Średnia ocen użytkownika: </Text>
